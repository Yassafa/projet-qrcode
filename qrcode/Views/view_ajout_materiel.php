<?php require "view_begin.php"; ?>
            ...
            <form action="?controller=admin&action=insert_materiel" method="post" id="form-ajout-materiel" autocomplete="off" enctype="multipart/form-data">
                <div>
                    ...
                    <input class="saisie" type="text" name="id-equipement" placeholder="Id" required pattern="^[A-Z,0-9]{5}$" minlength="5" maxlength="5"/>
                    <h4>ⓘ Lettres majuscules et chiffres uniquement</h4>
                </div>
